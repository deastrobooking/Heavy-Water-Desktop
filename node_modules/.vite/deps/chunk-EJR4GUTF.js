import {
  Light,
  ShadowLight
} from "./chunk-DXEDV4Z4.js";
import {
  PointerEventTypes,
  PointerInfo,
  PointerInfoPre
} from "./chunk-YH2TZGWG.js";
import {
  PickingInfo
} from "./chunk-4VCXMXI5.js";
import {
  Node
} from "./chunk-YRGEH6MW.js";
import {
  UniqueIdGenerator
...
import {
  ...
  EffectWrapper,
  Viewport
} from "./chunk-RE7EUPPQ.js";
import {
  Material
} from "./chunk-CTGGPJ5Z.js";
import {
  BoundingInfo
} from "./chunk-LNQROULM.js";
import {
...
} from "./chunk-IOIKMOO7.js";
import {
  UniformBuffer
} from "./chunk-X2BKO34B.js";
import {
  LightConstants
...
import {
  Texture,
  ThinTexture
} from "./chunk-AHXMAOLQ.js";
import {
  SerializationHelper,
  Tags
} from "./chunk-JWPSZA43.js";
import {
  Color3,
  Color4
} from "./chunk-B2NJCBNY.js";
import {
  Matrix,
  Quaternion,
  TmpVectors,
  ...
  Vector3,
  Vector4
} from "./chunk-EWEMAENR.js";
import {
  _ObserveArray
} from "./chunk-L6ZZHROD.js";
import {
  Tools
} from "./chunk-S2JFDENI.js";
import {
  DrawWrapper
} from "./chunk-RYUFMGNS.js";
import {
  VertexBuffer
...
var FrameGraphTask = class {
  ...
  _execute() {
    ...
    (_b = (_a = this._frameGraph.engine)._debugPushGroup) == null ? void 0 : _b.call(_a, `${this.getClassName()} (${this.name})`, 2);
    for (const pass of passes) {
      pass._execute();
    }
    (_d = (_c = this._frameGraph.engine)._debugPopGroup) == null ? void 0 : _d.call(_c, 2);
...
var ThinBlurPostProcess = class _ThinBlurPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./kernelBlur.fragment-IVXEWQCJ.js"), import("./kernelBlur.vertex-ZPC6BOOB.js")]));
    } else {
      list.push(Promise.all([import("./kernelBlur.fragment-UWFQDJVG.js"), import("./kernelBlur.vertex-2QPI5TDL.js")]));
    }
  }
  /**
...
var ShadowGenerator = class _ShadowGenerator {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_ShadowGenerator.ForceGLSL) {
      ...
      await Promise.all([
        import("./shadowMap.fragment-FREDAMG3.js"),
        import("./shadowMap.vertex-TOQX3VIX.js"),
        import("./depthBoxBlur.fragment-MICXO4HX.js"),
        import("./shadowMapFragmentSoftTransparentShadow-4ZHI7QFE.js")
      ]);
    } else {
      await Promise.all([
        import("./shadowMap.fragment-GX3FNFY7.js"),
        import("./shadowMap.vertex-YGU3KKLQ.js"),
        import("./depthBoxBlur.fragment-BH5R4DHG.js"),
        import("./shadowMapFragmentSoftTransparentShadow-QCYHUOGX.js")
      ]);
    }
...
var DepthRenderer = class _DepthRenderer {
  ...
  constructor(scene, type = 1, camera = null, storeNonLinearDepth = false, samplingMode = Texture.TRILINEAR_SAMPLINGMODE, storeCameraSpaceZ = false, name, existingRenderTargetTexture) {
    ...
    const renderSubMesh = (subMesh) => {
      ...
      if (this.isReady(subMesh, hardwareInstancedRendering) && camera2) {
        ...
        let renderingMaterial = (_a = effectiveMesh._internalAbstractMeshDataInfo._materialForRenderPass) == null ? void 0 : _a[engine2.currentRenderPassId];
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_DepthRenderer.ForceGLSL) {
      this._shaderLanguage = 1;
      await Promise.all([import("./depth.vertex-6QCWM4AG.js"), import("./depth.fragment-FWURVUMT.js")]);
    } else {
      await Promise.all([import("./depth.vertex-T6PPGO5G.js"), import("./depth.fragment-SVILZSBT.js")]);
    }
    this._shadersLoaded = true;
  }
  /**
...
var ThinMinMaxReducerPostProcess = class _ThinMinMaxReducerPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(import("./minmaxRedux.fragment-62VKY3Y2.js"));
    } else {
      list.push(import("./minmaxRedux.fragment-QSQVKTAL.js"));
    }
  }
...
var MultiRenderTarget = class extends RenderTargetTexture {
  ...
  get isSupported() {
    var _a;
    return ((_a = this._engine) == null ? void 0 : _a.getCaps().drawBuffersExtension) ?? false;
  }
  /**
  ...
  _createTextures(textureNames) {
    ...
    for (let i = 0; i < internalTextures.length; i++) {
      ...
      if (textureNames == null ? void 0 : textureNames[i]) {
  ...
  setInternalTexture(texture, index, disposePrevious = true) {
    ...
    if (!this.textures[index]) {
      ...
      this.textures[index].name = ((_a = this._textureNames) == null ? void 0 : _a[index]) ?? this.textures[index].name;
    }
  ...
  releaseInternalTextures() {
    var _a, _b;
    const internalTextures = (_a = this._renderTarget) == null ? void 0 : _a.textures;
    if (!internalTextures) {
      return;
    }
    ...
    (_b = this._renderTarget) == null ? void 0 : _b.dispose();
...
var ThinDepthPeelingRenderer = class _ThinDepthPeelingRenderer {
  ...
  _createEffects(finalEffectFragmentShaderName, finalEffectSamplerNames) {
    this._blendBackEffectWrapper = new EffectWrapper({
      ...
      extraInitializationsAsync: async () => {
        if (this._shaderLanguage === 1) {
          await import("./oitBackBlend.fragment-AU65IIDD.js");
        } else {
          await import("./oitBackBlend.fragment-TZK6YFRJ.js");
        }
      }
    });
    ...
    this._finalEffectWrapper = new EffectWrapper({
      ...
      extraInitializationsAsync: async () => {
        if (this._shaderLanguage === 1) {
          await import("./oitFinalSimpleBlend.fragment-5ZXRDELW.js");
        } else {
          await import("./oitFinalSimpleBlend.fragment-YOIANVOO.js");
        }
      }
    });
...
var FrameGraphRenderTarget = class {
  ...
  get renderTargetWrapper() {
    ...
    if (!this._renderTargetWrapper) {
      ...
      const creationOptionsForTexture = {
        textureCount: ((_a = this._renderTargets) == null ? void 0 : _a.length) ?? 0,
  ...
  dispose() {
    var _a;
    (_a = this._renderTargetWrapper) == null ? void 0 : _a.dispose();
  }
};
...
var FrameGraphObjectRendererTask = class extends FrameGraphTask {
  ...
  record(skipCreationOfDisabledPasses = false, additionalExecute) {
    ...
    (_a = this._rtForOrderIndependentTransparency) == null ? void 0 : _a.dispose();
    const pass = this._frameGraph.addRenderPass(this.name);
    ...
    pass.setExecuteFunc((context) => {
      ...
      const boundingBoxRenderer = (_a2 = this.getBoundingBoxRenderer) == null ? void 0 : _a2.call(this);
  ...
  _checkTextureCompatibility(targetTextures) {
    ...
    if (this.depthTexture !== void 0) {
      ...
      if (depthTextureDescription.options.samples !== outputTextureDescription.options.samples) {
        throw new Error(`${className} ${this.name}: the depth texture "${((_a = depthTextureDescription.options.labels) == null ? void 0 : _a[0]) ?? "noname"}" (${depthTextureDescription.options.samples} samples) and the output texture "${((_b = outputTextureDescription.options.labels) == null ? void 0 : _b[0]) ?? "noname"}" (${outputTextureDescription.options.samples} samples) must have the same number of samples`);
      }
    ...
    this._textureWidth = (outputTextureDescription == null ? void 0 : outputTextureDescription.size.width) ?? 1;
    this._textureHeight = (outputTextureDescription == null ? void 0 : outputTextureDescription.size.height) ?? 1;
    return depthEnabled;
  }
  _getTargetHandles() {
...
//# sourceMappingURL=chunk-EJR4GUTF.js.map
