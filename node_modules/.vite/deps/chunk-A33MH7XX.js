...
var OpenPBRMaterial = class _OpenPBRMaterial extends OpenPBRMaterialBase {
  ...
  constructor(name, scene, forceGLSL = false) {
    ...
    if (this.getScene() && !((_a = this.getScene()) == null ? void 0 : _a.getEngine().isWebGPU) && this.getScene().getEngine().webGLVersion < 2) {
    ...
    if (!_OpenPBRMaterial._noiseTextures[this.getScene().uniqueId]) {
      ...
      this.getScene().onDisposeObservable.addOnce(() => {
        var _a2;
        (_a2 = _OpenPBRMaterial._noiseTextures[this.getScene().uniqueId]) == null ? void 0 : _a2.dispose();
      ...
      if (scene.texturesEnabled) {
        ...
        if (radianceTexture && MaterialFlags.ReflectionTextureEnabled) {
          ...
          if (radianceTexture.irradianceTexture) {
            ...
            if (!radianceTexture.sphericalPolynomial && ((_a = radianceTexture.getInternalTexture()) == null ? void 0 : _a._sphericalPolynomialPromise)) {
              return false;
            }
          }
        }
  ...
  dispose(forceDisposeEffect, forceDisposeTextures) {
    ...
    if (forceDisposeTextures) {
      ...
      for (const key in this._samplersList) {
        const sampler = this._samplersList[key];
        (_a = sampler.value) == null ? void 0 : _a.dispose();
      }
      (_b = this._radianceTexture) == null ? void 0 : _b.dispose();
    }
    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./openpbr.vertex-L3TIPLPK.js"), import("./openpbr.fragment-B4FZSVXA.js")]);
        } else {
          await Promise.all([import("./openpbr.vertex-NLXING5M.js"), import("./openpbr.fragment-H5OBAN7B.js")]);
        }
...
//# sourceMappingURL=chunk-A33MH7XX.js.map
