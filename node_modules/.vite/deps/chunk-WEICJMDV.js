...
} from "./chunk-HZJ6W2WV.js";
import {
  AbstractAudioNode,
  _WebAudioParameterComponent
} from "./chunk-5KCSZNPD.js";
import {
  PickingInfo
...
var _WebAudioEngine = class extends AudioEngineV2 {
  ...
  async createBusAsync(name, options = {}) {
    const module = await import("./webAudioBus-UBKYVFHP.js");
  ...
  async createMainBusAsync(name, options = {}) {
    const module = await import("./webAudioMainBus-IKYWVWBB.js");
  ...
  async createSoundAsync(name, source, options = {}) {
    const module = await import("./webAudioStaticSound-QCII6DA4.js");
  ...
  async createSoundSourceAsync(name, source, options = {}) {
    const module = await import("./webAudioSoundSource-W2BOTBSE.js");
  ...
  async createStreamingSoundAsync(name, source, options = {}) {
    const module = await import("./webAudioStreamingSound-AXKQHHAP.js");
...
//# sourceMappingURL=chunk-WEICJMDV.js.map
