import {
  ...
  getVector3,
  getWeights
} from "./chunk-UHSEBOP4.js";
import {
  OpenPBRMaterialLoadingAdapter
} from "./chunk-BUS4IGEI.js";
import {
  PBRMaterialLoadingAdapter
} from "./chunk-TFAPSTDB.js";
import {
  FlowGraphGLTFDataProvider
} from "./chunk-2X5PKNBO.js";
import {
  AnimationEvent,
  AssetContainer,
  DataReader,
  ...
  addToBlockFactory,
  deepMerge
} from "./chunk-VQYWHOAP.js";
import {
  SpotLight
} from "./chunk-YBI7A7GJ.js";
import {
  Constants
...
import {
  PBRMaterial
} from "./chunk-AROZVQXI.js";
import "./chunk-QMJG4CG3.js";
import {
  FlowGraphCoordinator
} from "./chunk-VVT5APV5.js";
import "./chunk-2TY2RX26.js";
import "./chunk-SOAJK3AA.js";
import "./chunk-QU4SENKS.js";
import {
  AbstractMesh,
  TransformNode,
  VertexData
} from "./chunk-WEICJMDV.js";
import "./chunk-I66ABWQA.js";
import "./chunk-D6XSY5JG.js";
import "./chunk-PMNVTWUJ.js";
import {
  getAnimationTypeByFlowGraphType
} from "./chunk-JJ2M74JG.js";
...
import "./chunk-HEYZS3DI.js";
import "./chunk-B4REI2SD.js";
import "./chunk-SEA6XSZU.js";
import "./chunk-6G3JO5KX.js";
import "./chunk-NGTQDY4Y.js";
import "./chunk-J5C275UZ.js";
import "./chunk-HZJ6W2WV.js";
import "./chunk-UVSVBZKW.js";
import "./chunk-5KCSZNPD.js";
import {
  Bone
} from "./chunk-5YRJBPVW.js";
import {
  Animation
} from "./chunk-BUHSCF6R.js";
...
import "./chunk-UL3GLWQF.js";
import "./chunk-X5OHCEG7.js";
import "./chunk-DWOXNQCQ.js";
import "./chunk-QCIHLJPD.js";
import "./chunk-7SVSTJQN.js";
import "./chunk-VJESWLF2.js";
import "./chunk-5JF2ACPY.js";
import "./chunk-RRNRLXJ3.js";
import "./chunk-MJVQBSAE.js";
import "./chunk-VUZBMCLA.js";
import {
  Camera,
  DirectionalLight
} from "./chunk-EJR4GUTF.js";
import {
  Light
} from "./chunk-DXEDV4Z4.js";
import "./chunk-YH2TZGWG.js";
import "./chunk-4VCXMXI5.js";
import "./chunk-YRGEH6MW.js";
import "./chunk-WKXRXUEO.js";
import "./chunk-GFXF2AHA.js";
import "./chunk-23M3CJPH.js";
...
import "./chunk-PJ5IDD2Q.js";
import "./chunk-2DS53D5G.js";
import "./chunk-LJSODA3L.js";
import "./chunk-PTUQSPTS.js";
import "./chunk-RE7EUPPQ.js";
import "./chunk-4U4OQIRL.js";
import "./chunk-GXKTBWBP.js";
...
import "./chunk-IOIKMOO7.js";
import "./chunk-WVN4QNB4.js";
import "./chunk-X2BKO34B.js";
...
import "./chunk-L6ZZHROD.js";
import "./chunk-NOD22NBO.js";
import {
  Tools
} from "./chunk-S2JFDENI.js";
import "./chunk-RYUFMGNS.js";
import {
  Buffer,
...
var LazyAnimationGroupModulePromise = new Lazy(() => import("./animationGroup-LBIJBULY.js"));
var LazyLoaderAnimationModulePromise = new Lazy(() => import("./glTFLoaderAnimation-B6LGFD2X.js"));
var ArrayItem = class {
  /**
      ...
      if (!this.parent.skipMaterials && this._pbrMaterialImpl == null) {
        if (this.parent.useOpenPBR || this.isExtensionUsed("KHR_materials_openpbr")) {
          this._pbrMaterialImpl = {
            materialClass: (await import("./openpbrMaterial-253IGC7W.js")).OpenPBRMaterial,
            adapterClass: (await import("./openpbrMaterialLoadingAdapter-AV6Q7GYV.js")).OpenPBRMaterialLoadingAdapter
          };
        } else {
          this._pbrMaterialImpl = {
            materialClass: (await import("./pbrMaterial-QHX5FEWK.js")).PBRMaterial,
            adapterClass: (await import("./pbrMaterialLoadingAdapter-DA6EBAMQ.js")).PBRMaterialLoadingAdapter
          };
        }
      }
  ...
  loadMaterialBasePropertiesAsync(context, material, babylonMaterial) {
    ...
    if (material.normalTexture) {
      ...
      promises.push(this.loadTextureInfoAsync(`${context}/normalTexture`, material.normalTexture, (texture) => {
        ...
        if (((_a = material.normalTexture) == null ? void 0 : _a.scale) != void 0) {
  ...
  loadNodeAsync(context, node, assign) {
    return GLTFLoader2.LoadExtensionAsync(context, node, this.name, async (extensionContext, extension) => {
      ...
      return await this._loader.loadNodeAsync(context, node, (babylonMesh) => {
        ...
        switch (light.type) {
          case "rect": {
            const width = ((_a = light.rect) == null ? void 0 : _a.aspect) !== void 0 ? light.rect.aspect * size : size;
            const height = size;
  ...
  _loadClearCoatPropertiesAsync(context, properties, babylonMaterial) {
    ...
    if (properties.clearcoatNormalTexture) {
      ...
      promises.push(this._loader.loadTextureInfoAsync(`${context}/clearcoatNormalTexture`, properties.clearcoatNormalTexture, (texture) => {
        ...
        if (((_a = properties.clearcoatNormalTexture) == null ? void 0 : _a.scale) != void 0) {
...
var KHR_materials_variants = class _KHR_materials_variants {
  ...
  static _GetExtensionMetadata(rootNode) {
    var _a, _b;
    return ((_b = (_a = rootNode == null ? void 0 : rootNode._internalMetadata) == null ? void 0 : _a.gltf) == null ? void 0 : _b[NAME21]) || null;
  }
  /** @internal */
  onLoading() {
    const extensions = this._loader.gltf.extensions;
...
var TransmissionHelper = class _TransmissionHelper {
  ...
  _shouldRenderAsTransmission(material) {
    var _a;
    return ((_a = material == null ? void 0 : material.subSurface) == null ? void 0 : _a.isRefractionEnabled) ? true : false;
  }
  _addMesh(mesh) {
...
var KHR_materials_transmission = class {
  ...
  _loadTransparentPropertiesAsync(context, material, babylonMaterial, extension) {
    ...
    if (transmissionWeight > 0) {
      ...
      } else if (!((_a = scene._transmissionHelper) == null ? void 0 : _a._isRenderTargetValid())) {
...
var MSFT_lod = class {
  ...
  constructor(loader) {
    ...
    this._loader = loader;
    this.maxLODsToLoad = ((_a = this._loader.parent.extensionOptions[NAME33]) == null ? void 0 : _a.maxLODsToLoad) ?? this.maxLODsToLoad;
...
addToBlockFactory(NAME36, "FlowGraphGLTFDataProvider", async () => {
  return (await import("./flowGraphGLTFDataProvider-OHI457KZ.js")).FlowGraphGLTFDataProvider;
});
...
var SPLATFileLoader = class _SPLATFileLoader {
  ...
  applyAutoCameraLimits(meta, scene) {
    ...
    if ((meta.safeOrbitCameraRadiusMin !== void 0 || meta.safeOrbitCameraElevationMinMax !== void 0) && ((_a = scene.activeCamera) == null ? void 0 : _a.getClassName()) === "ArcRotateCamera") {
