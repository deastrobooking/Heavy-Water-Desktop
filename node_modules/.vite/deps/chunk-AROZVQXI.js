    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-A7IRGALR.js"), import("./pbr.fragment-XGYGVNRT.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-7H62N7TV.js"), import("./pbr.fragment-XZS4HK3E.js")]);
        }
...
//# sourceMappingURL=chunk-AROZVQXI.js.map
