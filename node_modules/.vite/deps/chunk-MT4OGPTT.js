...
var WebGPUEngine = class _WebGPUEngine extends ThinWebGPUEngine {
  ...
  _startRenderTargetRenderPass(renderTargetWrapper, setClearStates, clearColor, clearDepth, clearStencil) {
    ...
    const depthTextureView = depthMSAATextureView ? void 0 : gpuDepthStencilTexture == null ? void 0 : gpuDepthStencilTexture.createView(this._rttRenderPassWrapper.depthAttachmentViewDescriptor);
    const depthTextureHasStencil = gpuDepthStencilWrapper ? WebGPUTextureHelper.HasStencilAspect((gpuDepthStencilMSAATexture == null ? void 0 : gpuDepthStencilMSAATexture.format) ?? gpuDepthStencilWrapper.format) : false;
    const depthTextureHasDepth = gpuDepthStencilWrapper ? WebGPUTextureHelper.HasDepthAspect((gpuDepthStencilMSAATexture == null ? void 0 : gpuDepthStencilMSAATexture.format) ?? gpuDepthStencilWrapper.format) : false;
...
WebGPUEngine.prototype.updateMultipleRenderTargetTextureSampleCount = function(rtWrapper, samples) {
  ...
  for (let i = 0; i < count; ++i) {
    ...
    const gpuTextureWrapper = texture._hardwareTexture;
    gpuTextureWrapper == null ? void 0 : gpuTextureWrapper.releaseMSAATexture(rtWrapper.getBaseArrayLayer(i));
  }
...
//# sourceMappingURL=chunk-MT4OGPTT.js.map
